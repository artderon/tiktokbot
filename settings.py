API_TOKEN = "6441206056:AAGMnWGEIL9IoWLVbo1CDDca8fCFLKCemPI"

languages = {
    "ru": {
        "help": "Скачать видео или картинки с тиктока легко😉\nОтправь мне ссылку на видео или картинки.\nЕсли вы заметили ошибки отпишите @d0el0et0e",
    ...
    "ar": {
        "help": "قم بتنزيل الفيديو أو الصور من tiktok easy \ n أرسل لي رابط فيديو. \ n إذا رأيت أخطاء برسالة لي @d0el0et0e",
    ...
    "he": {
        "help": "הורד סרטון או תמונות מ-tiktok easy\nשלח לי קישור לסרטון.\nאם אתה רואה באגים שלח לי הודעה @d0el0et0e",
